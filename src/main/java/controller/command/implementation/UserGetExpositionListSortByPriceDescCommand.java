...
public class UserGetExpositionListSortByPriceDescCommand implements Command {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        List<Exposition> expositionsPriceDesc = userExpositionService.sortByPriceDescByPage(start, expositionsPerPage);
        List<Exposition.Category> categories = List.of(Exposition.Category.values());
        request.setAttribute("categories", categories);
        request.setAttribute("expositions", expositionsPriceDesc);
        request.setAttribute("page", page);
        return "/jsp/sort_by_price_desc.jsp";
    }
